...
\chapter*{Abstract}\label{abstract}
	...
	\paragraph{ADProject}~\\
		...
		\begin{itemize}
			...
			\item suddividere le attività in \glo{task} assegnandovi le risorse necessarie per il completamento degli stessi;
	...
	\begin{itemize}
		...
		\item il cliente al quale, che nel caso di un prodotto \glo{custom}, devono essere imputati i costi delle risorse utilizzate e di sviluppo;
