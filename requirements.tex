\begin{longtable}{|r l|p{2.5cm}|p{10cm}|}
	...
	Obbligatorio & L'applicazione ADCrm deve poter interrogare Salesforce per ottenere tutti i dati relativi agli utenti dell'azienda che utilizzano il \gls{CRM} recuperando: il campo identificativo, il nome, il cognome e la email\tabularnewline
	\hline
	& R-3F3 & Funzionale
