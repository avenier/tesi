...
\subsection{Database}
Il database è utilizzato per salvare i dati necessari a collegarsi per effettuare l'accesso e le richieste ai CRM, vista la bassissima mole di dati da salvare si è deciso di optare per un semplicissimo database \glo{SQL} composto da una singola tabella avente la seguente struttura:

%TODO: da aggiungere l'immagine della struttura ed una breve decsrizione dei campi

\subsection{Diagramma di sequenza}
%TODO: aggiungere i diagrammi di sequenza per una chiamata a proposal 